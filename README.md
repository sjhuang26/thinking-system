...
We would say that there is a "PORTAL" between A and B, written as A&B.
...
- Crowd A of neurons talks to Crowd B.
- The episodic memory of non-AB details such as the room, time of day, etc. is a "third item" X.
- A, B, and X are all episodic memories.
- A, B, and X are added and connected to the cognitive map.

**Why does the narrow focus of the exercise (only two cues and details within them) matter?**

1. Focusing on two items has the major advantage that the Incorrect case unambiguously points to a single item.
2. Two points makes a straight line and navigation is definetly based on straight lines.

**Do you need to have a clear conceptualization that detail is lost when you shift attention to the other item?**

- YES!
- There is a rapid shift of density from one item to another.
...
How to not get a training plateau!
...
- Ensuring the proper understanding of: CUE equals REWARD AND PUNISH equals PHYSICAL OBJECT equals WRAPPER (for hundreds of details).
  - Creating metaphors for reward, punishment, and the cue-detail relationship, clearly understood to be a hierarchy.
    ...
    - etc.
- Ensuring the proper understanding of the common sense of the "Ebbinghaus Asymptote": seeing an image and forgetting 90% of episodic detail between second 1 and second 10 implies (assume similar rates and extrapolate!) that second 0.01 must be an incredibly dense storage of thousands to millions of details and that second 0 must have virtually infinite detail density.
